...
For your pull request to be considered, all tests must pass. If some of them are failing you wil have to fix that problem before I will consider merging it. See the [vitest.config.ts](./vitest.config.ts) file for the required coverage percentages. If you're adding more code, please make sure to add tests that cover your code.
